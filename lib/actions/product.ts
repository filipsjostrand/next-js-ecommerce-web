...
// export async function createProduct(formData: FormData) {
//   const name = formData.get("name") as string;
//   const description = formData.get("description") as string; // Hämta beskrivningen
//   const price = Number(formData.get("price"));
//   const stock = Number(formData.get("stock"));
//   const imageUrl = formData.get("imageUrl") as string;
//   const categoryId = formData.get("categoryId") as string;
...
//       name,
//       slug: name.toLowerCase().replace(/ /g, "-").replace(/[^\w-]+/g, ""),
//       description, // Skicka med beskrivningen till Prisma
//       price,
//       stock,
//       imageUrl,
//       categoryId,
...
//   // Rensa cachen så att den nya produkten syns direkt i listan
//   revalidatePath("/admin/products");

//   // Skicka användaren tillbaka till listan
//   redirect("/admin/products");
// }
